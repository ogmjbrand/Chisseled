    ...
    <>
      ...
      >
        <div className="shell flex h-[var(--nav-h)] items-center justify-between gap-6">
          ...
          >
            <Monogram className="size-6 text-bone transition-colors duration-500 group-hover:text-emerald-bright" />
                  ...
                  <li key={section.label}>
                    ...
                    >
                      ...
                      <span
                        aria-hidden
                        className={[
                          "absolute inset-x-4 bottom-4 h-px origin-left bg-emerald-bright transition-transform duration-500 ease-[var(--ease-out-expo)]",
          ...
          <div className="flex items-center gap-1">
            ...
            >
              ...
              {wishlist.length > 0 && (
                <span className="absolute right-1 top-1 size-1.5 rounded-full bg-emerald-bright" />
              )}
            </Link>
            ...
            >
              ...
              <span
                className={[
                  ...
                  count > 0 ? "text-emerald-bright opacity-100" : "text-ash opacity-60",
                ].join(" ")}
              >
                {count}
              </span>
      ...
      <div className="shell grid grid-cols-12 gap-x-10 py-12">
                ...
                {col.links.map((link) => (
                  <li key={link.href + link.label}>
                    ...
                    >
                      ...
                      {link.note && (
                        <span className="font-mono text-micro uppercase tracking-[0.14em] text-emerald">
                          {link.note}
                        </span>
                      )}
                    </Link>
        ...
        >
          ...
          <div className="relative z-[3] flex h-full max-w-[24rem] flex-col justify-end p-8">
            <p className="eyebrow mb-3 text-emerald-bright">{section.feature.eyebrow}</p>
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col bg-ink lg:hidden animate-fade">
      ...
      <nav aria-label="Mobile" className="flex-1 overflow-y-auto overscroll-contain px-[var(--gutter)] py-6">
                            ...
                            {col.links.map((link) => (
                              <li key={link.href + link.label}>
                                ...
                                >
                                  {link.label}
                                  {link.note && (
                                    <span className="ml-2 font-mono text-micro uppercase tracking-[0.14em] text-emerald">
                                      {link.note}
                                    </span>
                                  )}
                                </Link>
        ...
        <Link href="/fit" onClick={onClose} className="btn btn-emerald btn-block mt-3">
          Find your fit
        </Link>
      </nav>
    </div>
