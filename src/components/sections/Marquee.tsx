  ...
  return (
    <div
      className={[
        ...
        accent ? "border-lime/25 bg-lime-shade/40" : "border-bone/10 bg-carbon",
      ].join(" ")}
      aria-hidden
    >
        ...
        {row.map((item, i) => (
          <span
            ...
            className={[
              ...
              accent ? "text-lime-bright" : "text-bone/45",
            ].join(" ")}
          >
            {item}
            <span className={accent ? "text-lime/50" : "text-bone/15"}>—</span>
          </span>
        ))}
      </div>
      ...
      <span
        className={[
          ...
          accent ? "from-lime-shade" : "from-carbon",
        ].join(" ")}
      />
      <span
        className={[
