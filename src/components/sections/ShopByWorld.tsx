...
import { WORLDS, getProductsByWorld } from "@/lib/catalog";
 ...
 */
export function ShopByWorld() {
  return (
    <section className="bg-ink section-pad" aria-labelledby="worlds-heading">
      <div className="shell mb-14 flex flex-wrap items-end justify-between gap-6">
        <div>
          <p className="eyebrow mb-5">02 — Navigate</p>
          <h2 id="worlds-heading" className="display-lg text-bone" data-reveal>
            Enter your world.
          </h2>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="relative z-[3] flex h-full flex-col justify-end p-6">
                ...
                <h3 className="display-md mb-3 text-bone">{world.name}</h3>

                <p className="mb-4 text-body-sm text-fog">{world.statement}</p>
