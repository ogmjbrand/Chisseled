      ...
      >
        ...
        <div className="shell relative z-[4] w-full">
          <div className="relative">
            {STAGES.map((stage, i) => {
              ...
              return (
                <div
                  ...
                  aria-hidden
                >
                  <p className="eyebrow mb-6 text-emerald-bright">
                    0{i + 1} — {stage.line}
                  </p>
            ...
            >
              <p className="eyebrow mb-6 text-emerald-bright">The Method</p>
              <p className="display-mega text-bone">Become</p>
              <p className="display-mega mb-9 text-emerald">Chisseled.</p>
              ...
              <li key={stage.id} className="flex items-center gap-2.5">
                <span
                  className={[
                    ...
                    active ? "w-14 bg-emerald-bright" : "w-7 bg-bone/25",
                  ].join(" ")}
                />
              </li>
            );
          ...
          <li>
            <span
              className={[
                ...
                resolve >= 0.5 ? "w-14 bg-emerald-bright" : "w-7 bg-bone/25",
              ].join(" ")}
            />
          </li>
        </ol>
    ...
    <section className="border-t border-bone/10 bg-ink section-pad" aria-labelledby="sequence-heading-static">
      <div className="shell">
          ...
          {STAGES.map((stage) => (
            ...
            >
              ...
              <div className="relative z-[3]">
                <p className="eyebrow mb-4 text-emerald-bright">{stage.line}</p>
        ...
        <div className="mt-14 border-t border-bone/10 pt-14">
          ...
          <p className="display-xl mb-9 text-emerald">Chisseled.</p>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link href="/shop" className="btn btn-primary">
              Shop the collection
              <ArrowMark className="size-4" />
