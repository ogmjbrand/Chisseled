...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 16800,
    flat: "jacket",
    media: { heather: "tech-fleece-set--heather", rust: "tech-fleece-set--rust" },
    sizes: APPAREL_SIZES,
    variants: [
      { colorway: "heather", inStock: ["S", "M", "L", "XL"], low: ["XL"] },
      { colorway: "onyx", inStock: ["S", "M", "L", "XL", "XXL"], low: [] },
  ...
  },
  {
    ...
    media: { onyx: "strappy-bra--onyx-back" },
    sizes: APPAREL_SIZES,
    variants: [{ colorway: "onyx", inStock: ["S", "M", "L", "XL", "XXL"], low: [] }],
    activities: ["training", "recovery", "everyday"],
    fit: "compression",
    isNew: true,
    story:
  ...
  },
  {
    ...
    price: 3600,
    flat: "tee",
    media: { onyx: "chisseled-fit-tank--onyx", red: "chisseled-fit-tank--red" },
    sizes: APPAREL_SIZES,
    variants: [
      { colorway: "onyx", inStock: ["S", "M", "L", "XL", "XXL"], low: [] },
      { colorway: "red", inStock: ["M", "L", "XL"], low: ["XL"] },
