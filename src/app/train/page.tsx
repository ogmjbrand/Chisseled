            ...
            {PROGRAMS.map((p, i) => (
              ...
              >
                ...
                <div className="relative z-[3]">
                  ...
                  <p className="mb-5 text-body-sm font-medium text-emerald-bright">{p.focus}</p>
                  ...
                  <ol className="mb-7 space-y-px overflow-hidden border border-bone/10 bg-bone/10">
                    {p.blocks.map((b) => (
                      <li key={b.name} className="flex gap-4 bg-ink p-3.5">
                        <span className="numeric w-16 shrink-0 font-mono text-micro uppercase tracking-[0.12em] text-emerald">
                          {b.weeks}
                        </span>
            ...
            {TIERS.map((tier, i) => (
              <article
                ...
                className={[
                  ...
                  tier.accent
                    ? "border-emerald/40 bg-gradient-to-b from-emerald/[0.08] to-transparent"
              ...
              >
                ...
                {tier.accent && (
                  <span className="badge badge-emerald absolute right-6 top-6">Most chosen</span>
                )}
              ...
              (coach, i) => (
                ...
                >
                  ...
                  <div className="relative z-[3] flex h-full flex-col justify-end p-6">
                    <p className="eyebrow mb-2.5 text-emerald-bright">{coach.discipline}</p>
                  ...
                  {c.live ? (
                    <span className="badge badge-emerald">
                      <span className="relative flex size-1.5">
                        <span
                          className="absolute inline-flex size-full rounded-full bg-emerald-bright"
                          style={{ animation: "chisseled-pulse-ring 2.4s ease-out infinite" }}
                        />
                        <span className="relative inline-flex size-1.5 rounded-full bg-emerald-bright" />
                      </span>
                      Live
                    </span>
                  ) : (
